...
app.initEvents = function() {
    ...
    //adding an init below for PHP link in list
    
   // document.getElementById("link1").addEventListener("click",functionPHP);
    
    document.getElementById("toScreen2").addEventListener("click", screen2);
    
    document.getElementById("btnDisplay").addEventListener("click",myFunction);
